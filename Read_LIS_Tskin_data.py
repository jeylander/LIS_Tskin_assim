...
def Read_LIS_Tskin_data(inDTG_YYYY, inDTG_mm, inDTG_dd, inDTG_hh, the_lat_point, the_lon_point, filedir):

    def find_nearest(array, value):
        idx = np.nanargmin(np.abs(value - array))
        return idx
        
    #filedir="/p/cwfs/eylandej/OPENLOOP/Noah36/SURFACEMODEL/SURFACEMODEL/"
    #filedir="/Volumes/SEAGATE5.0/Data/LIS_OUT/OPENLOOP/Noah36/"
    filepre="LIS_HIST_"
    filepost="00.d01.nc"
    ...
    print ('Reading Noah 36 Skin Temperature from file...', thefilename)
